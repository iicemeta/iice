...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "空天/NEO TOKYO NOIR 01", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/iicemeta", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://x.com/richardmikupro",
		},
		{
			name: "Instagram",
